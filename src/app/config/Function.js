...
export function checkRole(user, path) {
    return true
    // if (user.is_sysadmin) return true
    // return user.listPath.includes(path)
}
...
export const getColorStatusProduct = (id) => {
    switch (id) {
        case 9:
            return '#CFBA00'
        case 10:
            return '#01C2ED'
        // case 'CONTRACT_STATUS_FAIL':
        //     return '#E4483B'
        // case 'CONTRACT_STATUS_PAYMENT':
        //     return '#FFAC2F'
        case 11:
            return '#28B252'
    }
